...
export default function AvisoLegal() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-1 mt-20">
            <section className="left-0 top-0 flex-col mt-0   max-sm:h-10 h-40 justify-center border-b border-gray-300 bg-gradient-to-b  from-zinc-200 dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit backdrop-blur-2xl border-gray-300 text-[#fff] dark:border-neutral-800 
  ...
  lg:static  lg:rounded-xl lg:border lg:bg-neutral-300 lg:p-1 lg:dark:bg-zinc-800/30">
                <div className="z-10 w-full max-w-2xl items-center justify-between font-mono text-sm lg:flex " style={{ margin: 'auto' }}>
