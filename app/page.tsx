...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-1">
      ...
      {/* <p className="disclaimer"><i >Este sitio obtiene información de las API públicas del BCRA. No pertenece al gobierno ni a ningun movimiento político. Tiene como finalidad ser meramente informativo para la ciudadanía. </i></p> */}
      <CardFetch />
    </main>
  );
}
